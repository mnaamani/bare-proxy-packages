 ...
 * the job: `bare-https-proxy-agent` is the other, asking for a tunnel with `CONNECT`.
 *
 ...
 * target to use; the tunnel of `bare-https-proxy-agent` is what leaves TLS to the target
