...
// barex-https-proxy-agent, and the shared half in barex-proxy-agent. Nothing is implemented
// here; this is the table.
import { ProxyError, pairAgents, parseProxyUrl, proxyErrorIn, proxyName } from 'barex-proxy-agent'
...
// far end, which is what barex-socks-proxy-agent does for both; https:// is an http proxy
