// HTTP CONNECT (RFC 9110 section 9.3.6) for Bare, as http agents bare-fetch and bare-ws can be
...
// tunnel to an http:// target is *for* is the other package's business: barex-http-proxy-agent
...
// RFC 9110 section 5.1 field-name.
